...
public class WarehouseService
{
    ...
    private async Task AddImportedMaterialsAsync(KhoDbContext context, List<Category> categories)
    {
        ...
        var materialData = new[]
        {
            ...
            new { Name = "DT 86N", Unit = "m", Price = 0m, Category = "Gạch men 80x80", Supplier = (string)null },
            ...
            new { Name = "DT86N", Unit = "140", Price = 124000.0m, Category = "Khác", Supplier = "Xuân" },
            ...
            new { Name = "Sắt 10V", Unit = "cây", Price = 104600.0m, Category = "Khác", Supplier = "Xuân" },
            new { Name = "Sắt 14V", Unit = "cây", Price = 227400.0m, Category = "Khác", Supplier = "Xuân" },
            new { Name = "Sắt phi 10V", Unit = "cây", Price = 93000.0m, Category = "Khác", Supplier = "Xuân" },
